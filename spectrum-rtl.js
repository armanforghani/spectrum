...
(function (factory) {
    ...
    // Popular large color palette
    var defaultPalette = [
            // ['black', 'rgb(255, 128, 0);', 'hsv 100 70 50', 'rgba(20, 30, 40, 0.6)']
    ...
    var defaultOpts = {
        ...
        showAlpha: true,
        theme: "sp-light",
        palette: defaultPalette, //[["#ffffff", "#000000", "#ff0000", "#ff8000", "#ffff00", "#008000", "#0000ff", "#4b0082", "#9400d3"]],
        selectionPalette: [],
        disabled: false,
        offset: null
    },
    ...
    */
    function getOffset(picker, input) {
		...
		// RTL
        offset.left = Math.max(offset.left - dpWidth + input.outerWidth(), 0);
    ...
    */
    ...
    tinycolor.prototype = {
        ...
        toString: function(format) {
            ...
            // Use rgba format only if has Alpha
            if (hasAlpha) {
                return this.toRgbString();
            }
